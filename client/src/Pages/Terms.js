    ...
    <>
      <div className="min-h-screen bg-gray-100 flex items-center justify-center py-10 px-5 text-xs md:text-base">
        <div className="w-full max-w-4xl bg-white shadow-md rounded-lg p-8 overflow-y-auto">
          ...
          {/* Introduction */}
          <p className="mb-4">
            Opinod team welcomes you to our digital knowledge site. Below are
            our terms and conditions for use of the site, which you may access
            in several ways, including the World Wide Web, mobile phone, digital
            television, etc. These terms and conditions apply whenever you
            access the site, on whatever devices.
          </p>
          <p className="mb-4">
          ...
          <section className="mb-12">
            ...
            <ol className="list-decimal list-inside">
              <li className="mb-4">
                ...
                agree to be legally bound by these terms, which shall take
                effect immediately on your first use of opinod.com. If you do
                not agree to be legally bound by all the following terms please
                do not access and/or use opinod.com.
              </li>
              <li className="mb-4">
                <span className="font-medium">2)</span> Team may change these
                terms at any time by posting changes online. Please review these
                terms regularly to ensure you are aware of any changes made.
                Your continued use of opinod.com after changes to this policy
              ...
              <li className="mb-4">
                ...
                any way except for your own personal, non-commercial use. You
                also agree not to adapt, alter or create a derivative work from
                any opinod.com content except for your own personal,
                non-commercial use. Any other use of opinod.com content requires
                the prior written permission.
              </li>
              <li className="mb-4">
                <span className="font-medium">4)</span> The website opinod.com
                and the contents thereof (including but not limited to text,
                photographs, images, illustrations, designs, audio clips, video
                clips "look and feel", metadata, data or compilation) are
                protected by copyright and are intended strictly for personal
                and non-commercial use only. In this regard, non-commercial use
                shall not include the use of the website opinod.com and the
                contents thereof without prior written consent in connection
                with (a) the development of any software program, including but
                not limited to, training a machine learning or artificial
                intelligence (AI) systems or (b) providing archived or cached
                data sets containing the content(s) to other personal or entity.
              </li>
              <li className="mb-4">
          ...
          <section className="mb-12">
            ...
            <p className="mt-4">
              ...
              responsibility for any infection by virus, by other contamination
          ...
          <section className="mb-12">
            ...
            <ol className="list-decimal list-inside">
              ...
              <li className="mb-4">
                ii) Never reveal any personal information about yourself or
                anyone else (for example, telephone number, home address or
                email address).
              </li>
            </ol>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="mt-4">
              ...
              opinod.com, you may do so on the following terms and conditions:
            </p>
            <ol className="list-decimal list-inside mt-4">
              <li>
                Publication of any material you submit to us will be at your
                sole discretion. We reserve the right to make additions or
                deletions to the text or graphics prior to publication, or to
                refuse publication;
              </li>
              <li>
                You grant us a non-exclusive, perpetual, royalty-free, worldwide
                licence to republish any material you submit to us in any
                format, including, without limitation, print and electronic
                format;
              </li>
              <li>
              ...
              <li>
                ...
                services if we believe you are abusing the services in any way.
              </li>
            </ol>
          </section>
          ...
          <section className="mb-12">
            ...
            <p>
              ...
              do so in accordance with these Terms of Use. This means that you
              hereby agree that you have taken the photograph(s) you have sent
              to us or you have permission from or are authorised by the owner
              of the photograph(s) to send it (them) to us, and you are granting
              us a non-exclusive, royalty-free licence to publish or otherwise
              use the photograph(s) in any way and at any time we want on
              opinod.com.
            </p>
            <p className="mt-4">
              The photograph(s) must not be defamatory and may not break any
              laws.
            </p>
            <p className="mt-4">
              Selected photographs and graphical material will be published at
              the discretion of the editor and you will not be paid, even if
              your photograph(s) is (are) published.
            </p>
            <p className="mt-4">
            ...
            <p className="mt-4">
              Your name will be published alongside your photograph(s) or
              graphic, but we may edit or delete any comments, which you submit
              along with your photograph(s) or graphic.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p>
              ...
              yourself or anyone else (for example: telephone number, home
              address or email address). Please do not include postal addresses
              of any kind. If you have a helpful address to share, inform the
              host of the relevant community area using the 'Contact Us' link,
              and they will promote it if they see fit.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p>
              ...
              Act, 2000. All relevant rules, regulations, directions, orders and
              notifications will also apply. By choosing to browse this site,
              you agree to the site's Privacy Policy
            </p>
          </section>
        </div>
      </div>
